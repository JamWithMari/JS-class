...
function Cofee(size, isDecaf, qtyCream, qtySugar){
    this.size = size;
    ...
    this.description = function(){
        return `You got a ${this.size} ${this.decaf} coffee, with ${this.qtyCream} and ${this.qtySugar}`;
    }
}
/* STEP 2: Instatiate a coffee based on the above constructor function */
let jamariCoffee = new Cofee("medium", true, 4, 4);
output.textContent = jamariCoffee.description()
...
let robertCoffee = Object.create(jamariCoffee);
