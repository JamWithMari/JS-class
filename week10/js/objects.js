...
/* STEP 2a: Add other data items to the above object, like name, age, gender, address, and interests */
    ...
    interests: ["Skateboards", "Art", "Games"],
    greetings: function(){
        alert(`Hello ${this.name}, how are you?`);
    },
    bio: function(){
        return `The interest of ${this.name.firstName} ${this.name.lastName}, of age ${this.age}, living in ${this.address.city}, are ${this.interests}`
    }
}
